                ...
                <div className="md:flex">
                    ...
                    <div className="p-8 flex-grow">
                        ...
                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <InfoItem icon={<FaEnvelope className="text-indigo-500" />} label="Email" value={manager.email} />
                            <InfoItem icon={<FaPhone className="text-indigo-500" />} label="Phone" value={manager.phonenumber} />
