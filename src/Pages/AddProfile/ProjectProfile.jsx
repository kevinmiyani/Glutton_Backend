...
import { common, Project } from "../../api/call";
...
const ProjectProfile = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await Project.updateManager(manager._id, data);
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:bg-boxdark">
      <ToastContainer />

      <div className="bg-white dark:bg-boxdark rounded-xl shadow-lg overflow-hidden">
        <div className="md:flex">
          <div className="md:flex-shrink-0 dark:bg-boxdark  p-8 flex items-center justify-center ">
      ...
      <div className="p-8 dark:bg-boxdark">
        ...
        {isDatePickerOpen && (
          <div className="bg-white dark:bg-boxdark p-4 rounded-lg shadow-lg mb-4 w-max">
            <DatePicker
