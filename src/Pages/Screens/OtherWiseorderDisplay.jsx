...
const Order = () => {
  ...
  const fetchOrders = async (page) => {
    ...
    switch (role) {
      ...
      case "DESIGNER":
        ...
        break;
      case "ACCOUNTS":
        body.managers.Accounts = { managerid: uid }; // Adjusted for consistency with your earlier models
        break;
      default:
  ...
  const checkPendingStatus = (data) => {
    ...
    const isPending = managers.some(
      (manager) => data[manager]?.status === "Pending"
    );
