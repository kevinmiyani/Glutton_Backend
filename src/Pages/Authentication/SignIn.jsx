...
import Logo from '../../../src/images/logo/log.png';
import Logo1 from '../../../src/images/logo/logo1.jpeg';
...
const SignIn = () => {
    ...
    try {
      ...
      if (response.data.status) {
        if (response.data.data.role === "CUSTOMER") {
          toast.error("Customer not allow in hysun web, please try to login in App");
        } else {
  ...
  const handleForgotPassword = async (e) => {
    e.preventDefault();
    try {
      const res = await auth.forgetPassword({ email: forgotEmail });
  ...
  return (
    <>
      <div className=" vh-100 rounded-sm border border-stroke bg-white  shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <ToastContainer />
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center align-middle justify-center">
              <div className="w-100 flex justify-center align-middle " style={{ paddingRight: '50px' }}>
                <img className="dark:hidden w-20" src={Logo} alt="Logo" />
              </div>
              <div className="w-100 flex justify-center align-middle mt-2" style={{ paddingRight: '50px' }}>
                <img className="dark:hidden w-40" src={Logo1} alt="Logo" />
              </div>
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-2 pl-6 pr-10 text-black outline-none focus:border-success focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                    />
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        ...
                        >
                          <path
                            d="M11 2C5.60714 2 1.44643 5.81667 0 11C1.44643 16.1833 5.60714 20 11 20C16.3929 20 20.5536 16.1833 22 11C20.5536 5.81667 16.3929 2 11 2ZM11 17.6667C7.02679 17.6667 3.875 14.851 2.63125 11C3.875 7.14905 7.02679 4.33333 11 4.33333C14.9732 4.33333 18.125 7.14905 19.3688 11C18.125 14.851 14.9732 17.6667 11 17.6667Z"
                            fill=""
                          />
                          <path
                            d="M11 6.66667C9.39551 6.66667 8.08333 7.98024 8.08333 9.58333C8.08333 11.1864 9.39551 12.5 11 12.5C12.6045 12.5 13.9167 11.1864 13.9167 9.58333C13.9167 7.98024 12.6045 6.66667 11 6.66667Z"
                            fill=""
                          />
                        </svg>
                      ) : (
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full cursor-pointer rounded-lg border border-success bg-green-600 p-2 text-white transition hover:bg-opacity-90"
                  >
      ...
      <Modal
        ...
        style={{
          content: {
            ...
            width: '400px', // Adjust the width as per your need
            padding: '20px',
            borderRadius: '8px',
      ...
      >
        ...
        <form onSubmit={handleForgotPassword}>
          ...
          {forgotMessage && <p className="mt-4 text-center text-red-500">{forgotMessage}</p>}
        </form>
      </Modal>
