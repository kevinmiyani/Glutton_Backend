...
import Logo1 from '../../../src/images/logo/log1.png';
        ...
        <div className="flex flex-wrap items-center ">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <div className="w-100 flex justify-center align-middle mt-2">
                ...
                <div className="mb-5">
                  ...
                  <div className="text-center mt-2">
                    <p>
                      ...
                      <Link to="/auth/signin" className="text-green-600">
                        Sign in
                      </Link>
                    </p>
                  </div>
